 ...
 **********************************************************************************************************/
    ...
    struct DirectionCosineMatrix
    {
        ...
        static void unit_test() {
            ...
            for(size_t i=0; i<sizeof(dcm_str)/sizeof(dcm_str[0]); i++) {
    ...
    class iMyAhrsPlus
    {
        ...
        // prevent copy
        iMyAhrsPlus(iMyAhrsPlus& rhs):protocol(this) {(void) rhs;}
    ...
    protected:
         ...
         */
        virtual void OnSensorData(int sensor_id, SensorData sensor_data) {(void) sensor_id; (void) sensor_data;}
        virtual void OnAttributeChange(int sensor_id, std::string attribute_name, std::string value) {(void) sensor_id; (void) attribute_name; (void) value;}
